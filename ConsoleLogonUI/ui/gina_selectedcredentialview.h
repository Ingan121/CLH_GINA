...
#define IDC_CREDVIEW_XP_LOCKED_GROUP 2421
#define IDC_CREDVIEW_XP_LOCKED_INFO 1852
#define IDC_CREDVIEW_XP_LOCKED_USERNAME_INFO 1952
#define IDC_CREDVIEW_XP_LOCKED_ICON 2404
...
static int credViewTabIndex[] = {
	IDC_CREDVIEW_PASSWORD,
	IDC_OK,
	IDC_CANCEL,
	IDC_CREDVIEW_SHUTDOWN,
	IDC_CREDVIEW_OPTIONS,
	IDC_CREDVIEW_USERNAME,
};

static int credViewLockedTabIndex[] = {
	IDC_CREDVIEW_LOCKED_PASSWORD,
	IDC_OK,
	IDC_CANCEL,
	IDC_CREDVIEW_LOCKED_USERNAME,
};

static int chpwTabIndex[] = {
	IDC_CHPW_OLD_PASSWORD,
	IDC_CHPW_NEW_PASSWORD,
	IDC_CHPW_CONFIRM_PASSWORD,
	IDC_OK,
	IDC_CANCEL,
	IDC_CHPW_USERNAME,
};
