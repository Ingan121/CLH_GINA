...
void ginaManager::LoadGina()
{
	...
	if (!hGinaDll)
	{
		MessageBoxW(0, L"Failed to load msgina.dll! Please put a copy of msgina.dll from a Windows 2000 installation in system32.", L"Error", MB_OK | MB_ICONERROR);
...
void ginaManager::LoadBranding(HWND hDlg, BOOL isLarge, BOOL noBarAsImgCtrl)
{
    RECT rect;
